...
public class InstaAdapter2 extends RecyclerView.Adapter<InstaAdapter2.ViewHolder> {
    private List<Post> mPosts;
    Context context;
    private final int REQUEST_CODE = 21;
    private final int REQUEST_CODE_1 = 22;
    // pass in the Tweets array in the constructor
    public InstaAdapter2(List<Post> posts) {
        mPosts = posts;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View tweetView = inflater.inflate(R.layout.item_post2, parent, false);
...
//        });
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            ivPost = (ImageView) itemView.findViewById(R.id.ivProfile);
